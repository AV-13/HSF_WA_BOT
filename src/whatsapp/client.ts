...
export class WhatsAppClient {
  ...
  async sendDocument(
    ...
    try {
      ...
      console.error('❌ Error sending WhatsApp document:');
  ...
  async sendImage(
    ...
    try {
      ...
      if (caption) {
        console.log(`💬 Bot: ${caption}`);
      }
      console.log(`🖼️ Sent image menu`);
      return response.data;
    } catch (error: any) {
  ...
  async sendInteractiveButtons(
    ...
    try {
      ...
      console.log(`💬 Bot: ${bodyText}`);
      console.log(`🔘 Sent ${buttons.length} interactive buttons`);
      return response.data;
    } catch (error: any) {
  ...
  async sendInteractiveList(
    ...
    try {
      ...
      console.log(`💬 Bot: ${bodyText}`);
      console.log(`📋 Sent interactive list with ${sections[0]?.rows.length || 0} options`);
      return response.data;
    } catch (error: any) {
  ...
  async sendLocationMessage(
    ...
    try {
      ...
      console.log(`📍 Sent location: ${name || 'Location'}`);
      return response.data;
    } catch (error: any) {
